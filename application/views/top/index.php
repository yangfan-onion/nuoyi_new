                    ...
                    <div class="carouselContainer">
                        <div class="carousel slide" data-type="single" id="carousel-547f24d14c4aa7208200004d">
                            <div class="carousel-inner">
                                <div class="item"><img alt="" src="<?php echo base_url();?>static/image/top/gallery/gallery_1.jpg"></div>
                        ...
                        <div class="span8">
                            <div class="widgetContainer">
                                <div class="textContainer">
                                    ...
                                    <h2>御熙妍</h2>
                                    <p>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;御熙妍10年科研专注，女性在阳光暴晒.雾霾气候.化妆残留及碱性物质等对肌肤的刺激时，出现皮肤微创期所产生的粗糙。干纹。晦暗。敏感等特点，修复美白一步到位，敏感肌肤适用。安全高效，一周亲历见证肌肤焕白新生，从肌底散发光感透白的健康美肌。
                                    </p>
                                    <p>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;御熙妍凭借自身的崭新技术，创新ECA营养导入技术（促进皮肤代谢解决吸收）。ECB成熟延展技术（舒缓修复改善肌底）。ECC渗透技术（坚实肌肤持久亮白）三项自有技术更精确有效的把精华成分输送到肌底中，提高活性成分的能力和功效，体现御熙妍面膜的神奇效果。
                                    </p>
                                </div>
                            </div>
                        </div>
